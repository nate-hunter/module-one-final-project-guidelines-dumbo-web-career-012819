def fourth_scenario
  ...
  def break_door_lock
    system "clear"
    puts "You find a metal pipe nearby and try to break the lock. You smash it a few times but it doesn’t break."
  end

  def kick_down_door
    system "clear"
    puts "You take a few steps back and try to kick the door down. It shakes the door but it doesn’t seem to be working."
  end

  def find_another_way
    system "clear"
    puts "You go around the temple in search of another way in. You find a closed window right around the corner."
  ...
  def go_around
    system "clear"
    puts "The window seems too high to climb. You continue looking for a more suitable entrance. As you run around the temple, you find an open side door. You go inside. The temple is filled with smoke and it’s hard to see, but you can still hear the villagers."
  ...
  def break_window
    system "clear"
    puts "You look around and find a large rock. You throw the rock and it breaks the window. With a running start, you climb the wall and hang on the window ledge. You pull yourself up and make your way into the temple. Finally inside, you notice the temple is filled with smoke and it’s hard to see, but you can still hear the villagers."
  ...
  def follow_sounds
    system "clear"
    puts "You call out for the villagers and their screams become louder. You follow their cries and find them huddled in a corner."
  ...
  def burning_pillar
    system "clear"
    puts "You tell the villagers to stay where they are and you’ll find a safe way to leave the temple. They’re hesitant but agree to stay put. You go back the way you came, but all of a sudden, you feel a rumble. Out of nowhere a burning pillar falls from the ceiling. You have 3 seconds to respond"
  ...
  def burning_pillar_with_villagers
    system "clear"
    puts "You tell the villagers to hold hands and follow you. You lead them back the way you came, but all of a sudden, you feel a rumble. Out of nowhere a burning pillar falls from the ceiling. You have 3 seconds to respond"
  ...
  def jump
    system "clear"
    puts "You jump backwards and the pillar crashes in front of you. The way you came has been blocked. You turn around and search for another exit. At that moment, you see a glimmer of sunlight in the corner."
  ...
  def block
    system "clear"
    puts "You block the pillar from falling on you with your bending. The pillar is so heavy you strain yourself, but you manage to move it over to the side, preventing it from blocking the exit."
  ...
  def block_with_villagers
    system "clear"
    puts "You block the pillar with your bending and hold it up. You yell at the villagers to quickly move under the pillar and out to safety. You’re strained beyond belief but somehow manage to keep the pillar from falling on top of the villagers as they scurry outside."
  ...
  def move_pillar
    system "clear"
    puts "You try to move the pillar with your bending, but it’s too heavy. You call to the villagers and tell them to stay where they are. You try to find a way around, but it’s hopeless."
  ...
  def give_up
    system "clear"
    puts "The task at hand is too monumental for you. You decide the best course of action is to abandon the villagers and save yourself. You run towards the exit and make it outside. Once you catch your breath, you continue going through the village."
  end
  ...
  def check_exit
    system "clear"
    puts "You decide you should check if there are any other surprises along the way. Fortunately, there aren't any and the way out seems clear."
  ...
  def tell_villagers_to_follow
    system "clear"
    puts "You tell the villagers you found a way out and tell them to follow you. They eagerly get up and follow you outside."
  ...
  def destroy_pillar
    system "clear"
    puts "Unable to move the pillar, you try to destroy it instead. You gather all your remaining strength and attack the pillar. A few seconds later the pillar is destroyed and you can finally guide the villagers to safety."
  ...
  def sunlight
    system "clear"
    puts "You follow the sunlight and find a door. You try opening it but it’s locked shut."
  ...
  def accept_fate
    system "clear"
    puts "Exhausted, injured, and unmotivated, you give up and sit down with your back against the door. You think back to your childhood and question what decisions you had to make to get here. As you start to doze off, you think to yourself, 'This isn't so bad'. You give into the fumes and the heat and give up."
  end
  ...
  puts "You continue making your way through the village and come across a burning temple. You can hear people yelling for help inside."
  ...
  def intro_prompt(intro_prompt_answer)
    ...
    if intro_prompt_answer == "Run inside and save them"
      ...
      system "clear"
      puts "It’s too dangerous and you need to save your energy in case you run into more trouble. You continue making your way through the village."
    end
  end
  ...
  def break_temple_lock(break_temple_lock_answer)
    ...
    if break_temple_lock_answer == "Continue trying"
      system "clear"
      puts "You can’t give up so soon. With all your might you give the lock one final smash, and it breaks open. You kick the door open and run inside. The temple is filled with smoke and it’s hard to see, but you can still hear the villagers."
  ...
  def kick_temple_door(kick_temple_door_answer)
    ...
    if kick_temple_door_answer == "Continue trying"
      system "clear"
      puts "You can’t give up so soon. You take a few steps back, run up and try to break the door. It doesn’t budge and you’ve hurt yourself in the process. You give up trying to kick the door down."
