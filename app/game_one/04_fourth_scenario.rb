def fourth_scenario(current_user)
  ...
  def continue(current_user)
    prompt = TTY::Prompt.new
    continue_answer = prompt.select(' ', ["Continue walking"])
  end

  def continue_prompt(continue_answer, current_user)
    continue_answer == final_scenario(current_user)
  end
